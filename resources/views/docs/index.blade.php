...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div><div class="middle"><div id="requirement-1-vehicle-search-get" class="action get"><h4 class="action-heading"><div class="name">Search</div><a href="#requirement-1-vehicle-search-get" class="method get">GET</a><code class="uri">/vehicles/{model_year}/{manufacturer}/{model}</code></h4><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>model_year</dt><dd><code>number</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>2015</span></span><p>Vehicle’s model year</p>
</dd><dt>manufacturer</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>Audi</span></span><p>Vehicles’s manufacturer name</p>
</dd><dt>model</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>A3</span></span><p>Vehicle’s model name</p>
</dd></dl></div></div></div><hr class="split"><div class="middle"><section id="requirement-2" class="resource-group"><h2 class="group-heading">Requirement 2 <a href="#requirement-2" class="permalink">&para;</a></h2></section></div><div class="middle"><div id="requirement-2-vehicle-search" class="resource"><h3 class="resource-heading">Vehicle Search <a href="#requirement-2-vehicle-search" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname">http://marra-nhtsa.herokuapp.com/api</span>/vehicles</span></div><div class="tabs"><div class="example-names"><span>Requests</span><span class="tab-button">example 1</span></div><div class="tab"><div><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">modelYear</span>": <span class="hljs-value"><span class="hljs-number">2015</span></span>,
  "<span class="hljs-attribute">manufacturer</span>": <span class="hljs-value"><span class="hljs-string">"Audi"</span></span>,
  "<span class="hljs-attribute">model</span>": <span class="hljs-value"><span class="hljs-string">"A3"</span>
</span>}</code></pre><div style="height: 1px;"></div><h5>Schema</h5><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">modelYear</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span>
    </span>}</span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="requirement-2-vehicle-search-post" class="action post"><h4 class="action-heading"><div class="name">Search</div><a href="#requirement-2-vehicle-search-post" class="method post">POST</a><code class="uri">/vehicles</code></h4></div></div><hr class="split"><div class="middle"><section id="requirement-3" class="resource-group"><h2 class="group-heading">Requirement 3 <a href="#requirement-3" class="permalink">&para;</a></h2></section></div><div class="middle"><div id="requirement-3-vehicle-search" class="resource"><h3 class="resource-heading">Vehicle Search <a href="#requirement-3-vehicle-search" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://marra-nhtsa.herokuapp.com/api</span>/vehicles/<span class="hljs-attribute" title="model_year">2015</span>/<span class="hljs-attribute" title="manufacturer">Audi</span>/<span class="hljs-attribute" title="model">A3</span>?withRating=<span class="hljs-attribute" title="with_rating">true</span></span></div><div class="tabs"><div class="tabs"><div class="example-names"><span>Responses</span><span class="tab-button">200</span></div><div class="tab"><div><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">Count</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
  "<span class="hljs-attribute">Message</span>": <span class="hljs-value"><span class="hljs-string">"Results returned successfully"</span></span>,
  "<span class="hljs-attribute">Results</span>": <span class="hljs-value">[
    {
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div><div class="middle"><div id="requirement-3-vehicle-search-get" class="action get"><h4 class="action-heading"><div class="name">Search</div><a href="#requirement-3-vehicle-search-get" class="method get">GET</a><code class="uri">/vehicles/{model_year}/{manufacturer}/{model}?withRating={with_rating}</code></h4><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>with_rating</dt><dd><code>boolean</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>true</span></span><p>Indicates if should return ratings info</p>
</dd><dt>model_year</dt><dd><code>number</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>2015</span></span><p>Vehicle’s model year</p>
</dd><dt>manufacturer</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>Audi</span></span><p>Vehicles’s manufacturer name</p>
</dd><dt>model</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>A3</span></span><p>Vehicle’s model name</p>
</dd></dl></div></div></div><hr class="split"><div class="middle"><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 31 Aug 2017</p></div></div></div></div><script>/* eslint-env browser */
